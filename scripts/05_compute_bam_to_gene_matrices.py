...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--gene-upstream-bins", type=int, default=None, help="Bins for upstream distance in gene profile.")
    parser.add_argument("--gene-body-bins", type=int, default=None, help="Bins for scaled gene body in gene profile.")
    parser.add_argument("--gene-downstream-bins", type=int, default=None, help="Bins for downstream distance in gene profile.")
